...
class Solution {
    void solve(Node* root, Node* &first, Node* &mid, Node* &last, Node* &temp) {
        if(!root) return;
        
        solve(root->left, first, mid, last, temp);
        ...
        temp = root;
        solve(root->right, first, mid, last, temp);
    }
  public:
    void correctBST(Node* root) {
        // add code here.
        Node *first = NULL, *last = NULL, *mid = NULL, *temp = NULL;
        
        solve(root, first, mid, last, temp);
